...
public class CController {
	...
	static Logger logger = LoggerFactory.getLogger(CController.class);
	...
	@RequestMapping(value = "/cjoin2", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/cback", method = RequestMethod.GET)
	public String back(Model model) {
		logger.trace("back method");
		return "c-index";
	}
	
	@RequestMapping(value = "/cwriteBoard", method = RequestMethod.GET)
	...
	@RequestMapping(value = "cwriteBoard", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/cdetailBoard", method = RequestMethod.GET)
	public String detailBoard(Model model, int boardNo) {
		...
		return "c-writeReboard";
	}

	@RequestMapping(value = "cwriteReboard", method = RequestMethod.POST)
	...
	@RequestMapping(value ="/clanuageBoard", method=RequestMethod.GET)
	...
	@RequestMapping(value ="/callBoard", method=RequestMethod.GET)
	...
	@RequestMapping(value ="/cmyBoard", method=RequestMethod.GET)
	...
	@RequestMapping(value ="cdetailMyBoard", method=RequestMethod.GET)
	public String detailMyBoard(Model model, HttpSession session,int boardNo){
		logger.trace("detailMyBoard method");
		Board board = bDao.selectBoard(boardNo);
		model.addAttribute("board", board);
		model.addAttribute("reboards",rDao.selectReboard(boardNo));
		return "c-detailMyBoard";
	}
	
	@RequestMapping(value ="cmyDetailBoardReturn", method=RequestMethod.GET)
	...
	public void mailSender(HttpServletRequest request, ModelMap mo,
		...
		String subject = "有人跟帖你的句子"; 					  //메일 제목 입력해주세요.
		String body = "你先开动到网站后确认一下"; //메일 내용 입력해주세요.
