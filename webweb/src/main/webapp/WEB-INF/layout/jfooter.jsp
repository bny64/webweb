...
<div class="wrapper style5">
		<section id="team" class="container">
			<header class="major">
				<h2>いろんな言語で接続できます</h2><br>
			</header>
			<div class="row">
				<div class="3u">
					<a href="#" class="image"><img src="<%=request.getContextPath()%>/img/korea.png"	alt=""></a>
					<h3>한국어</h3>
				...
				<div class="3u">
					<a href="#" class="image"><img src="<%=request.getContextPath()%>/img/america.jpg"	alt=""></a>
					<h3>english</h3>
