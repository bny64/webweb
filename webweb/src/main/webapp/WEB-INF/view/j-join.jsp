...
<div class="wrapper style2">
		<section class="container">
		<div id="join">
		<c:url value="/jjoin2" var="jjoin2"/>
		<form method="post" action="${jjoin2 }">
			<h1>新規登録</h1>
				<label>名前</label><br>
				...
				<h6>最初加入の時10ポイントを得られます</h6><br>
				
				<input type="submit" value="加入">
				</form><br>
				<c:url value="/jback" var="jback"/>
				<a href="${jback }"><input type="button" value="戻る"></a>
				</div>
		</section>
	</div>
