...
<body class="homepage">
	...
	<div class="wrapper style2">
		<section class="container">
					...
					<div id="login">
						<h2>ログイン</h2><br>
						<c:url value="/jjoin" var="jjoin"/>
						<c:url value="/jlogin" var="jlogin"/>
						<form method="post" action="${jlogin }">
						<label>アカウント</label><br>
						<input type="text" id="id" name="id"><br>
						<label>パスワード</label><br>
						<input type="password" id="password" name="password"><br>
						<input type="submit" value="接触" id="BtnLogin">
						</form><br>
						<a href="${jjoin}"><input type="button" value="新規登録"></a>
					</div>
		</section>
	</div>
