		...
		<section class="container">
			...
			<div id="login">
				...
				<form method="post" action="${login }">
					<label>아이디</label><br> <input type="text" id="id" name="id"><br>
					<label>비밀번호</label><br> <input type="password" id="password"
						name="password"><br> <input type="submit" value="접속"
						id="BtnLogin">
				</form>
				<br> <a href="${join}"><input type="button" value="회원가입"></a>
			</div>
		</section>
	</div>
	...
	$("#calendar")
			.on(
					...
					function() {
						...
						window
								.open("${calendar}", "캘린더",
										'height=500, Width=700, left=440, top=300, color=white');
					});
